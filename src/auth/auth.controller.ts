import { Controller, Post, Body, Res, HttpStatus, Req, Logger, HttpCode, Inject, UseGuards, Request, Get } from '@nestjs/common';
...
export class AuthController {
    ...
    @Post('login')
    async login(@Request() req: any, @Res() response: any): Promise<JSON> {
